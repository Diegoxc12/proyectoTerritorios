...
$anuncios = [];
$mensaje_error_anuncios = "";
$mensaje_bienvenida = "Anuncios y eventos";
try {
    $stmt = $conn->prepare("
        SELECT id, fecha_anuncio, titulo_anuncio, descripcion_anuncio
        FROM anuncios
...
$eventos = [];
$mensaje_error_eventos = "";

try {
    $stmt_eventos = $conn->prepare("
        SELECT id, fecha_evento, titulo_evento, descripcion_evento
        FROM eventos
        WHERE visible = 1 AND (fecha_expiracion IS NULL OR fecha_expiracion > NOW())
...
<head>
    ...
    <link rel="stylesheet" href="../assets/styles/ver_anuncios.css">
    <link href="https://cdn.jsdelivr.net/npm/aos@2.3.4/dist/aos.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600;700&display=swap" rel="stylesheet">
    <title>Totoranorte - Dashboard</title>
</head>
<body>
    ...
    <div class="page-container">
        <main>
            ...
            <section id="anuncios" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                <h2 id="anuncios_titulo">Presione en un anuncio para editar: </h2>
                ...
                <div class="content-grid">
                    <?php if (count($anuncios) > 0 ): ?>
                        <?php foreach ($anuncios as $anuncio): ?>
                            <a id = "edicion_anuncios" href="editar_anuncio.php?id=<?php echo htmlspecialchars($anuncio['id']); ?>">
                            <div class="anuncio" data-aos="fade-up" data-aos-delay="100">
                                <h3 class="fecha_anuncio"><?php echo htmlspecialchars(date('d F Y', strtotime($anuncio['fecha_anuncio']))); ?></h3>
            ...
            <section id="eventos" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                <h2 id="eventos_titulo">Presione en un evento para editar: </h2>
                ...
                <div class="content-grid">
                    <?php if (count($eventos) > 0): ?>
                        <?php foreach ($eventos as $evento): ?>
                            <a id = "edicion_anuncios" href="editar_evento.php?id=<?php echo htmlspecialchars($evento['id']); ?>">
                            <div class="anuncio" data-aos="fade-up" data-aos-delay="100">
                                <h3 class="fecha_anuncio"><?php echo htmlspecialchars(date('d F Y', strtotime($evento['fecha_evento']))); ?></h3>
