...
$mensaje_bienvenida = "Grupo del domingo";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['eliminar_id'])) {
        ...
        try {
            $stmt_eliminar = $conn->prepare("UPDATE territorio_domingo SET visible = 0 WHERE id_territorio = ?");
    ...
    if (isset($_POST['territorios']) && is_array($_POST['territorios'])) {
        ...
        if (!$errores_en_territorios && !empty($territorios_a_insertar)) {
            try {
                ...
                $stmt_territorio = $conn->prepare("INSERT INTO territorio_domingo (territorios_asignado, fecha_asignacion, fecha_expiracion_territorio, tipo, visible) VALUES (?, ?, ?, ?, 1)");
...
try {
    $stmt_fetch_territorios = $conn->prepare("SELECT id_territorio, territorios_asignado, tipo FROM territorio_domingo WHERE fecha_expiracion_territorio > NOW() AND visible = 1 ORDER BY territorios_asignado ASC;");
     ...
     <main>
        ...
        <div class="form-container">
            <form id="campaignForm" action="agregar_campaña.php" method="POST">
                ...
                <div class="form-group">
                    <h2>Conductor: Diego Xavier</h2>
                </div>

                <div class="form-group">
                    <h2>Lugar: Casa Flia. Vizñay</h2>
                </div>
            </form>
        ...
        <h2 id="agregar_campana_titulo">Grupos 1, 3 y 4</h2>
        <div class="form-container">
            <form id="territorioFormManana" action="grupo_domingo.php" method="POST">
                <div class="form-group">
                    <h2>Hora: 8:30 AM</h2>
                </div>

                <div class="form-group">
                    <h2>Conductor: Fernando Bustamente</h2>
                </div>

                <div class="form-group">
                    <h2>Lugar: Casa Flia. Bustamante</h2>
                </div>

                <?php if (isset($_SESSION['rol_usuario']) && $_SESSION['rol_usuario'] === 'anciano'): ?>
                <div class="mensaje-importante">
                    <p>Para asignar territorios para el grupo 1, 3 y 4 escriba en <span> "Tipo de territorio" </span>exactamente esto <span>"grupo 1, 3 y 4"</span></p>
                </div>
                <?php endif; ?>

                <hr class="section-divider">
                <h2 class="section-header">Territorios para el grupo 1, 3 y 4</h2>
                ...
                <div class="territorio-button-container">
                    ...
                    if (!empty($territorios_asignados)) {
                        foreach ($territorios_asignados as $territorio) {
                            ...
                            if (isset($territorio['tipo']) && $territorio['tipo'] === 'grupo 1, 3 y 4') {
        ...
        <h2 id="agregar_campana_titulo">Grupos 2 y 5</h2>
        <div class="form-container">
            <form id="territorioFormNoche" action="grupo_domingo.php" method="POST">
                <div class="form-group">
                    <h2>Hora: 8:30 AM</h2>
                </div>

                <div class="form-group">
                    <h2>Conductor: Ancianos/siervos</h2>
                </div>

                <div class="form-group">
                    <h2>Lugar: Flia. Vizñay</h2>
                </div>
                
                <?php if (isset($_SESSION['rol_usuario']) && $_SESSION['rol_usuario'] === 'anciano'): ?>
                <div class="mensaje-importante">
                    <p>Para asignar territorios para el grupo 2 y 5 escriba en <span> "Tipo de territorio" </span>exactamente esto <span>"grupo 2 y 5"</span></p>
                </div>
                <?php endif; ?>

                <hr class="section-divider">
                <h2 class="section-header">Territorios para el grupo 2 y 5</h2>
                ...
                <div class="territorio-button-container">
                    ...
                    if (!empty($territorios_asignados)) {
                        foreach ($territorios_asignados as $territorio) {
                            ...
                            if (isset($territorio['tipo']) && $territorio['tipo'] === 'grupo 2 y 5') {
                                $numero_territorio = htmlspecialchars($territorio['territorios_asignado']);
                                $id_territorio = htmlspecialchars($territorio['id_territorio']);
